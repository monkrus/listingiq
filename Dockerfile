...
ENV HOSPITABLE_CLIENT_ID=build-placeholder
ENV HOSPITABLE_CLIENT_SECRET=build-placeholder
...
# Create cache dir so Next.js image optimization can write to it
