...
const PLANS = [
  {
    ...
    subtitle: '1 listing',
    features: [
      'Title, description & amenity analysis',
      'AI-written title + description rewrites',
      'SEO keywords & guest persona match',
      'Priority action plan with scores',
  ...
  },
  {
    ...
    features: [
      ...
      'AI photo analysis — upload yours or we analyze your listing photos',
      'Keep / retake verdict for each photo',
      'Best photo order + hero shot pick',
    ],
...
export default function PricingPage() {
  ...
  function handleCheckout(planKey: string) {
    ...
    // Reset loading state if user navigates back (e.g. redirect fails or browser back)
    window.addEventListener('pageshow', () => setLoading(null), { once: true })
  }
