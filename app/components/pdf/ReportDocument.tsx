      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.content}>
          ...
          <SectionCard title="Review sentiment" score={d.reviewScore}>
            <Text style={s.subLabel}>Review highlights</Text>
        ...
        <View style={s.footer} fixed>
          <View style={s.footerRow}>
            <Text style={s.footerText}>Generated by ListingIQ · AI-generated guidance, results may vary. Use alongside your own judgement. Not affiliated with Airbnb.</Text>
