...
function buildTextReport(d: ReportData): string {
  ...
  const lines: string[] = [
    ...
    ``,
    divider,
    `Generated by ListingIQ — listingiq.com`,
...
function CopyReportButton({ data }: { data: ReportData }) {
  ...
  async function handleCopy() {
    try {
      ...
      textarea.value = buildTextReport(data)
...
export default function Report({ data: d, onReset, plan = 'quick-score', isDemo = false, listingUrl = '' }: Props) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 pb-20">
      ...
      {/* Scrape status */}
      {!isDemo && d.wasScraped && (
        <p className="text-xs text-stone-600 text-center mb-3">Data extracted from your Airbnb listing page</p>
      )}
      ...
      <div className="bg-white border border-stone-200 rounded-2xl p-6 mb-4 flex items-center gap-6">
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {hasPdf && <DownloadPdfButton data={d} photoResults={photoResults} photoPreviews={photoPreviews} />}
            <CopyReportButton data={d} />
          </div>
        </div>
      </div>
      ...
      {/* Save nudge for Quick Score */}
      {!hasPdf && !isDemo && (
        <div className="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 mb-4 flex items-center justify-between">
          <p className="text-xs text-blue-700">
            Save your report — use <strong>Copy report</strong> above to copy the full analysis as text.
            Want a PDF? <span className="font-medium">Upgrade to Full Audit.</span>
          </p>
        </div>
      )}
          ...
          <div className="max-w-xs mx-auto">
            <div className="rounded-xl p-4 text-center border-2 border-stone-900">
              ...
              <ul className="text-xs text-stone-600 space-y-1 mb-3 text-left inline-block">
                ...
                <li className="flex gap-1.5"><span className="text-green-600">✓</span>PDF report download</li>
              </ul>
              {isDemo ? (
                <button
